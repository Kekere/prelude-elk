...
def extractcve(cveid):
  ...
  if response.status_code == 200:
      ...
      software_noun=np.array(["scadabr","webex","keycloak","openfind","tracker","wordpress","cloud","zimbra","teclib","zebra","soft","unity","word","webex","excel","explorer","office","apache","acrobat","control","modicon","bank","financial","symantec","s-cms","ibm","adobe","realnetworks","trend micro","hp","blue coat","samba","ca","apache","firefox","antivirus","application","smart","app","freeware","sap","mobile","vbscript","digital","client","mcafee","cardio"])
      context=''
